...
import com.example.project_vmo.services.impl.GoodServiceImpl;
...
class GoodServiceImplTest {
  ...
  void testGetAllGoods() {
    ...
    final GoodResponse expectedResult = new GoodResponse(
        List.of(new GoodDto(0, "goodsName", 0, List.of(new ImageDto(0, "name")))), 0, 1, 0L, 0,
        false, List.of(new Image(0, "name",
    ...
    // Run the test
    final GoodResponse result = goodServiceImplUnderTest.getAllGoods(0, 1);
  ...
  void testGetAllGoods_GoodRepoReturnsNoItems() {
    // Setup
    final GoodResponse expectedResult = new GoodResponse(
        List.of(new GoodDto(0, "goodsName", 0, List.of(new ImageDto(0, "name")))), 0, 0, 0L, 0,
        false, List.of(new Image(0, "name",
        new Good(0, "goodsName", 0, new GregorianCalendar(2020, Calendar.JANUARY, 1).getTime(),
            new GregorianCalendar(2020, Calendar.JANUARY, 1).getTime(), false, List.of()))));
  ...
  @Test
  void testCreateGood_ThrowsIOException() {
    // Setup
    final GoodDto goodDto = new GoodDto(0, "goodsName", 0, List.of(new ImageDto(0, "name")));
    final MultipartFile[] files = new MultipartFile[]{};
    ...
    // Run the test
    assertThatThrownBy(() -> goodServiceImplUnderTest.createGood(goodDto, files))
